        ...
        {movies.length > 0 || shows.length > 0 ? (
          <div className="">
            <div className="flex justify-center">
              ...
              >
                Load More
              </button> : <button disabled type="button" class="fixed bottom-[10px] hover:shadow-md hover:shadow-black active:shadow-none text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
<svg aria-hidden="true" role="status" class="inline h-4 me-3 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
