    ...
    <>
      {selected?.includes(filter.id) ? (
        <button
          ...
          className={` border-2 rounded-lg p-2 m-2 bg-indigo-500 hover:bg-blue-400 shadow-black active:bg-blue-100 shadow-sm active:translate-y-[4px] translate-y-[2px] active:outline-offset-4 hover:shadow-black active:border active:shadow-none `}
        >
          <h3>{filter.name}</h3>
        </button>
      ) : (
